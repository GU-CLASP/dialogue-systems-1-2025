...
const dmMachine = setup({
  ...
  states: {
    ...
    Greeting: {
      ...
      states: {
        Prompt: {
          entry: { type: "spst.speak", params: { utterance: `Hello! Say a sentence!` } },
    ...
    CheckGrammar: {
      entry: {
        type: "spst.speak",
        params: ({ context }) => {const utterance = context.lastResult && context.lastResult.length > 0  ? context.lastResult[0].utterance  : "";
